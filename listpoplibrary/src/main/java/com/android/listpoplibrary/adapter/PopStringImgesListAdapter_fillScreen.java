...
public class PopStringImgesListAdapter_fillScreen extends BaseAdapter {
    ...
    public PopStringImgesListAdapter_fillScreen(List<ListPopModel> list, Context context) {
        this.list = list;
        this.context = context;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.popwindow_listview_imgs_fillscreen_item, viewGroup, false);
